    ...
    <section className="py-24 px-4 md:px-8 w-full max-w-7xl mx-auto bg-stone-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[300px] md:auto-rows-[400px]">
        ...
        <BentoItem
          ...
          imageUrl="https://picsum.photos/seed/mom1/800/600"
        ...
        <BentoItem
          ...
          imageUrl="https://picsum.photos/seed/mom2/600/800"
          title="Sabedoria"
        ...
        <BentoItem
          className="md:col-span-1"
          imageUrl="https://picsum.photos/seed/mom3/600/600"
          title="Alegria"
        ...
        <BentoItem
          className="md:col-span-2"
          imageUrl="https://picsum.photos/seed/mom4/800/600"
